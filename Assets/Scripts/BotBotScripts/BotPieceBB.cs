...
public class BotPieceBB : MonoBehaviour
{
    public BotBoardBB board { get; private set; }
    ...
    public void Initialize(BotBoardBB board, Vector3Int position, TetrominoData data)
    {
        this.board = board;
